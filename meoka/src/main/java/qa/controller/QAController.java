...
/*
  ...
  public String modifyPagingPOST(QAVO qa, SearchCriteria cri, RedirectAttributes rttr) throws Exception {
  ...
  public String registPOST(QAVO qa, RedirectAttributes rttr) throws Exception {
