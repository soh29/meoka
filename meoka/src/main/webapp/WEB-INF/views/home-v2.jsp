...
<!DOCTYPE html>
<!-- saved from url=(0047)home-v2.html -->
		...
		<div class="container">
			...
			<header class="tstbite-header bg-white">
				<div class="d-flex align-items-center py-1 py-md-4">
					<div class="tstbite-header-links d-inline-block d-md-none">
...
<path data-name="Icon Color"
				...
				<nav
					class="navbar navbar-expand-md has-header-inner px-0 border-top border-bottom">
					<div class="tstbite-header-links d-none d-md-inline-block">
						<a href="javascript:void(0);" class="search-link"> <svg
								xmlns="http://www.w3.org/2000/svg" width="26.667"
								height="26.667" viewBox="0 0 26.667 26.667">
<path
...
<path
					...
					<div class="tstbite-header-links d-none d-md-inline-block">
						<a href="home-v2.html#0"> <svg
								xmlns="http://www.w3.org/2000/svg" width="20" height="14"
								viewBox="0 0 20 14">
<path
									d="M1,14a1,1,0,0,1,0-2H19a1,1,0,0,1,0,2ZM1,8A1,1,0,0,1,1,6H19a1,1,0,0,1,0,2ZM1,2A1,1,0,0,1,1,0H19a1,1,0,0,1,0,2Z"></path>
</svg>
						</a>
					</div>
							...
							<div class="search-results" id="SearchList">
								...
								<div class="tstbite-search-list">
									<a href="home-v2.html#0">
										...
										<div class="tstbite-search-name">
											<strong class="small">Double Thick Layered Sponge
												Cake</strong>
										</div>
									</a>
								</div>
			...
			<section class="tstbite-components mb-4 mb-md-5">
				<div class="row">
					<div class="col-md-4">
						<figure class="my-3 tstbite-card">
							<a href="home-v2.html#0"
								class="tstbite-animation rounded-top-6"> <img
								src="./resources/img/menu66.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-2 px-3 px-lg-4">
								...
								<h6 class="font-weight-semibold inter-font f-size-20 mt-2 mb-4">
									<a href="home-v2.html#0"
										class="text-black d-block mt-1">Very Berry Healthy Summer
										Smoothie</a>
								</h6>
							</figcaption>
						</figure>
					...
					<div class="col-md-4">
						<figure class="my-3 tstbite-card">
							<a href="home-v2.html#0"
								class="tstbite-animation rounded-top-6"> <img
								src="./resources/img/menu67.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-2 px-3 px-lg-4">
								<div class="w-100 float-left">
									<div class="float-left">
								...
								<h6 class="font-weight-semibold inter-font f-size-20 mt-2 mb-4">
									<a href="home-v2.html#0"
										class="text-black d-block mt-1">Creamy Carrot and Ginger
										Soup</a>
								</h6>
							</figcaption>
						</figure>
					...
					<div class="col-md-4">
						<figure class="my-3 tstbite-card">
							<a href="home-v2.html#0"
								class="tstbite-animation rounded-top-6"> <img
								src="./resources/img/menu68.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-2 px-3 px-lg-4">
								<div class="w-100 float-left">
									<div class="float-left">
								...
								<h6 class="font-weight-semibold inter-font f-size-20 mt-2 mb-4">
									<a href="home-v2.html#0"
										class="text-black d-block mt-1">Loaded Mixed Berries Mini
										Tarts</a>
								</h6>
							</figcaption>
						</figure>
			...
			<section
				class="tstbite-components bg-primary-light my-5 px-3 px-md-5 py-5 py-md-4 rounded-6 tstbite-join-section">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<h6 class="mt-0 mt-md-3 mb-3 text-center text-lg-left">
							Daily Cooking tips and <br>recipes to your inbox!
						</h6>
					</div>
					<div class="col-lg-6">
			...
			<section class="tstbite-components my-4 my-md-5">
				<div class="row">
					<div class="col-md-8">
						<h6 class="mt-3 mb-4">Latest Recipes</h6>
						<figure class="my-3">
							<img src="./resources/img/menu44.jpg"
								class="w-100 rounded-top-12" alt="Menu">
							<figcaption
								class="bg-white px-4 px-lg-5 pt-4 mb-4 tstbite-collection border-top-0 rounded-bottom-6">
								<div class="w-100 float-left my-3">
									<div class="float-left">
										<div class="fabrx-ratings has-rating rating">
								...
								<h6 class="font-weight-semibold inter-font mt-2 mb-3">
									<a href="home-v2.html#0"
										class="text-black">Pumpkin Marshmallow Pie</a>
								</h6>
								<p class="font-weight-medium">The perfect dessert for fall!
									finally found the perfect way to make the flakiest crust, and
									the toasted marshmallow is to die for!</p>
								<div
									class="d-md-flex justify-content-between align-items-center flex-wrap my-4">
									<div>
										<span class="circle"><img
											src="./resources/img/avatar1.png" class="rounded-circle"
											alt="Avatar"></span> <small class="pl-1">Tricia Albert</small>
									</div>
									<div class="d-flex flex-wrap justify-content-end mt-4 mt-md-0">
										<div class="text-gray-300">
											<img src="./resources/img/chat.svg" alt="Avatar"> <small>456</small>
										</div>
										<div class="ml-4 text-gray-300">
											<img src="./resources/img/calendar.svg" alt="Avatar"> <small>Yesterday</small>
										</div>
									</div>
								</div>
							</figcaption>
						...
						<div class="py-2">
							<figure class="my-3 row align-items-center tstbite-card">
								<div class="col-md-6">
									<a href="home-v2.html#0"
										class="tstbite-animation stretched-link rounded-left-6 rounded-sm-top-6">
										<img src="./resources/img/menu52.jpg" class="w-100" alt="Menu">
									</a>
								</div>
								<figcaption class="bg-white col-md-6">
											...
											<div class="float-left">
												<div class="fabrx-ratings has-rating rating">
													<input type="radio" id="radio21" name="rate5" value="1"
														...
														type="radio" id="radio23" name="rate5" value="3">
													<label for="radio23" class="custom-starboxes"></label> <input
														type="radio" id="radio24" name="rate5" value="4">
													<label for="radio24" class="custom-starboxes"></label> <input
														type="radio" id="radio25" name="rate5" value="5">
													<label for="radio25" class="custom-starboxes"></label>
												</div>
											</div>
										</div>
										<h6 class="inter-font f-size-20 pr-0 pr-lg-5 mt-2 mb-3">
											<a href="home-v2.html#0"
												class="text-black">Mighty Cheesy Breakfast Burger</a>
										</h6>
										<div>
											<img src="./resources/img/avatar1.png" class="rounded-circle"
												alt="Avatar"> <small class="pl-1">Tricia
												Albert</small>
										</div>
										<div class="d-flex flex-wrap mt-4">
											<div class="text-gray-300">
												<img src="./resources/img/calendar.svg" alt="Avatar">
						...
						<div class="py-2">
							<figure class="my-3 row align-items-center tstbite-card">
								<div class="col-md-6">
									<a href="home-v2.html#0"
										class="tstbite-animation stretched-link rounded-left-6 rounded-sm-top-6">
										<img src="./resources/img/menu53.jpg" class="w-100" alt="Menu">
									</a>
								</div>
								<figcaption class="bg-white col-md-6">
									<div class="px-3 px-md-1 px-lg-3 pt-3">
											...
											<div class="float-left">
												<div class="fabrx-ratings has-rating rating">
													<input type="radio" id="radio26" name="rate6" value="1"
														...
														type="radio" id="radio28" name="rate6" value="3">
													<label for="radio28" class="custom-starboxes"></label> <input
														type="radio" id="radio29" name="rate6" value="4">
													<label for="radio29" class="custom-starboxes"></label> <input
														type="radio" id="radio30" name="rate6" value="5">
										...
										<h6 class="inter-font f-size-20 pr-0 pr-lg-5 mt-2 mb-3">
											<a href="home-v2.html#0"
												class="text-black">Chocolate and Berries Healthy Pudding</a>
										</h6>
										<div>
											<img src="./resources/img/avatar1.png" class="rounded-circle"
												alt="Avatar"> <small class="pl-1">Tricia
						...
						<div class="py-2">
							<figure class="my-3 row align-items-center tstbite-card">
								<div class="col-md-6">
									<a href="home-v2.html#0"
										class="tstbite-animation stretched-link rounded-left-6 rounded-sm-top-6">
										<img src="./resources/img/menu54.jpg" class="w-100" alt="Menu">
									</a>
								</div>
								<figcaption class="bg-white col-md-6">
									<div class="px-3 px-md-1 px-lg-3 pt-3">
										<div class="w-100 float-left">
											<div class="float-left">
												<div class="fabrx-ratings has-rating rating">
													<input type="radio" id="radio31" name="rate7" value="1">
													<label for="radio31" class="custom-starboxes"></label> <input
														type="radio" id="radio32" name="rate7" value="2"
														checked="checked"> <label for="radio32"
														class="custom-starboxes"></label> <input type="radio"
														id="radio33" name="rate7" value="3"> <label
														for="radio33" class="custom-starboxes"></label> <input
														type="radio" id="radio34" name="rate7" value="4">
													<label for="radio34" class="custom-starboxes"></label> <input
														type="radio" id="radio35" name="rate7" value="5">
													<label for="radio35" class="custom-starboxes"></label>
												</div>
											</div>
										</div>
										<h6 class="inter-font f-size-20 pr-0 pr-lg-5 mt-2 mb-3">
											<a href="home-v2.html#0"
												class="text-black">Caramel Cream Birthday Pudding</a>
										</h6>
										<div>
											<img src="./resources/img/avatar1.png" class="rounded-circle"
												alt="Avatar"> <small class="pl-1">Tricia
						...
						<div class="py-2">
							<figure class="my-3 row align-items-center tstbite-card">
								<div class="col-md-6">
									<a href="home-v2.html#0"
										class="tstbite-animation stretched-link rounded-left-6 rounded-sm-top-6">
										<img src="./resources/img/menu59.jpg"
										class="w-100 rounded-left-6 rounded-sm-top-6" alt="Menu">
									</a>
								</div>
								<figcaption class="bg-white col-md-6">
									<div class="px-3 px-md-1 px-lg-3 pt-3">
										<div class="w-100 float-left">
											<div class="float-left">
												<div class="fabrx-ratings has-rating rating">
													<input type="radio" id="radio36" name="rate8" value="1">
													<label for="radio36" class="custom-starboxes"></label> <input
														type="radio" id="radio37" name="rate8" value="2">
													<label for="radio37" class="custom-starboxes"></label> <input
														type="radio" id="radio38" name="rate8" value="3"
														checked="checked"> <label for="radio38"
														class="custom-starboxes"></label> <input type="radio"
														id="radio39" name="rate8" value="4"> <label
														for="radio39" class="custom-starboxes"></label> <input
														type="radio" id="radio40" name="rate8" value="5">
													<label for="radio40" class="custom-starboxes"></label>
												</div>
											</div>
										</div>
										<h6 class="inter-font f-size-20 pr-0 pr-lg-5 mt-2 mb-3">
											<a href="home-v2.html#0"
												class="text-black">Healthy Caramel Strawberry Milkshake</a>
										</h6>
										<div>
											<img src="./resources/img/avatar1.png" class="rounded-circle"
												alt="Avatar"> <small class="pl-1">Tricia
					...
					<div class="col-md-4">
						<figure class="text-center tstbite-profile rounded-6 border">
							<img src="./resources/img/avatar2.png" class="rounded-circle"
								alt="Menu">
							<figcaption class="bg-white px-2 py-4 rounded-bottom-6">
								<h6 class="font-weight-semibold inter-font f-size-24">Hi,
									I'm Tara</h6>
								<p class="text-black mb-4">I’m a former dentist with a big
									passion for food, now I’m full time food blogger. I love
									exploring new cooking techniques as well as easy and fun
									recipes.</p>
								<a href="home-v2.html#0"
									class="btn btn-sm btn-outline-dark py-1 font-weight-medium">Read
									More</a>
							</figcaption>
						</figure>
						<h6 class="mt-4 mt-xl-5 pt-4 pt-xl-5 mb-3">Fresh Recipes</h6>
						<div class="row">
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu46.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Pan
												Fried Cod in Creamy Kale Sauce</a>
										</h6>
									</figcaption>
								</figure>
							</div>
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu47.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Ricotta
												Chicken Salad</a>
										</h6>
									</figcaption>
								</figure>
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu48.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Easy
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu49.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Birthday
												Cupcakes</a>
										</h6>
									</figcaption>
								</figure>
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu50.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">4
												healthy Lunch Prep Recipes</a>
										</h6>
									</figcaption>
								</figure>
							</div>
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu51.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Berry
												Maddness Biscuts</a>
										</h6>
									</figcaption>
								</figure>
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu55.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Tumeric
												Lavendar Tea</a>
										</h6>
									</figcaption>
								</figure>
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu56.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Four
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu57.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
												href="recipe-sidebar.html">Orange
												and Lemon Curd</a>
										</h6>
									</figcaption>
								</figure>
							...
							<div class="col-6">
								<figure class="my-3 text-center tstbite-card">
									<a
										href="recipe-sidebar.html"
										class="tstbite-animation stretched-link"> <img
										src="./resources/img/menu58.jpg" class="w-100" alt="Menu">
									</a>
									<figcaption class="bg-white pt-2">
										<h6 class="font-weight-semibold inter-font small">
											<a
						...
						<div class="mt-4 mt-lg-5 pt-4 pt-lg-5">
							<div class="d-flex flex-wrap align-items-center">
								<div>
									<img src="./resources/img/brand3.svg" alt="Brands">
								</div>
								<div class="ml-auto">
									<a href="home-v2.html#0"
										class="btn btn-sm btn-outline-dark font-weight-medium hover-orange">Follow</a>
								</div>
							</div>
							<div class="d-flex flex-wrap my-3">
								<div class="tstbite-instagram-info">
									<strong class="font-weight-semibold">575</strong> <small
										class="text-gray-300 d-block">posts</small>
								</div>
								<div class="tstbite-instagram-info">
									<strong class="font-weight-semibold">12.7K</strong> <small
										class="text-gray-300 d-block">followers</small>
								</div>
								<div class="tstbite-instagram-info">
									<strong class="font-weight-semibold">45</strong> <small
										class="text-gray-300 d-block">following</small>
								</div>
							</div>
							<div class="d-flex flex-wrap tstbite-instagram-list">
								<div class="w-50 p-1">
									<img src="./resources/img/menu60.jpg" class="w-100" alt="Menu">
								</div>
								<div class="w-50 p-1">
									<img src="./resources/img/menu61.jpg" class="w-100" alt="Menu">
								</div>
								<div class="w-50 p-1">
									<img src="./resources/img/menu62.jpg" class="w-100" alt="Menu">
								</div>
								<div class="w-50 p-1">
									<img src="./resources/img/menu63.jpg" class="w-100" alt="Menu">
								</div>
								<div class="w-50 p-1">
									<img src="./resources/img/menu64.jpg" class="w-100" alt="Menu">
								</div>
								<div class="w-50 p-1">
									<img src="./resources/img/menu65.jpg" class="w-100" alt="Menu">
								</div>
							</div>
						</div>
					</div>
			...
			<section class="tstbite-components my-4 my-md-5">
				<h5 class="py-3 mb-0 h3">Curated Collections</h5>
				<div class="row">
					...
					<div class="col-xl-4 col-md-6">
						<figure class="my-3 tstbite-card">
							...
							<figcaption
								...
								<div class="text-black pt-3 pb-4 px-4 text-right">
									<h6 class="mb-3 md-lg-0 pr-0 pr-lg-4 text-left">
										<a href="home-v2.html#0">Everything
											Bagel</a>
									</h6>
									<span class="btn btn-sm btn-outline-dark text-nowrap">156
										Recipes</span>
					...
					<div class="col-xl-4 col-md-6">
						<figure class="my-3 tstbite-card">
							...
							<figcaption
								...
								<div class="text-black pt-3 pb-4 px-4 text-right">
									<h6 class="mb-3 md-lg-0 pr-0 pr-lg-4 text-left">
										<a href="home-v2.html#0">Exquisite
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								...
								src="./resources/img/menu69.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Caramel
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu70.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Cashew
									Vegan Rice</a>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu71.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Smoked
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu72.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Salmon
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu73.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Healthy
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu74.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Chocolate
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu75.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Caramel
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu76.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Blueberry
									Carrot Cake</a>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu77.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Vegan
									Cauliflower Salad</a>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu78.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Roasted
									Red Pepper Soup</a>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu79.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Eggs
									and Avocado Toast</a>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu80.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Pork
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu81.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Toasted
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu82.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Cheesy
					...
					<div class="col-lg-4 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							<a href="recipe-sidebar.html"
								class="tstbite-animation stretched-link rounded-6"> <img
								src="./resources/img/menu83.jpg" class="w-100" alt="Menu">
							</a>
							<figcaption class="mt-3 pb-3">
								<a href="recipe-sidebar.html"
									class="text-black d-block big font-weight-semibold">Fig and
									Raisins Oatmeal</a>
							</figcaption>
						</figure>
					</div>
...
<path
						...
						<ul>
							<li><a
								href="home-v2.html#0">About
									us</a></li>
							<li><a
								href="home-v2.html#0">Careers</a></li>
							<li><a
								href="home-v2.html#0">Contact
									us</a></li>
							<li><a
								href="home-v2.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="home-v2.html#0">Terms</a></li>
							<li><a
								href="home-v2.html#0">Conditions</a></li>
							<li><a
								href="home-v2.html#0">Cookies</a></li>
							<li><a
								href="home-v2.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="home-v2.html#0">Facebook</a></li>
							<li><a
								href="home-v2.html#0">Twitter</a></li>
							<li><a
								href="home-v2.html#0">Instagram</a></li>
							<li><a
								href="home-v2.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<path
	...
	<script src="./resources/js/swiper-bundle.min.js.다운로드"
		type="text/javascript"></script>
	<script src="./resources/js/masonry.min.js.다운로드"
		type="text/javascript"></script>
	<script src="./resources/js/tastebite-scripts.js.다운로드"
		type="text/javascript"></script>
	<script defer="" src="./resources/js/beacon.min.js.다운로드"
		data-cf-beacon="{&quot;rayId&quot;:&quot;6a50cadb99da0af4&quot;,&quot;version&quot;:&quot;2021.10.0&quot;,&quot;r&quot;:1,&quot;token&quot;:&quot;9ae02b4a12234f118cf01e6f25c04e9d&quot;,&quot;si&quot;:100}"></script>
