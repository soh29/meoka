			...
			<section class="tstbite-components my-4 my-md-5">
				<div class="row align-items-center pt-0 pt-md-5">
					<div class="col-lg-9 col-8 col-6">
						<h5 class="py-2 py-md-3 mb-0">게시판 등록</h5>
					</div>
									...
									<div class="box-body">
										...
										<div class="form-group">
											<label for="exampleInputEmail1">BNO</label> <input
												type="text" name='bno' class="form-control"
												value="${QAVO.bno}" readonly="readonly">
										</div>
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="content" rows="3">${QAVO.content}</textarea>
										</div>
