...
<!DOCTYPE html>
<!-- saved from url=(0045)about.html -->
...
<title>Tastebite - About</title>
<link
	href="assets/images/favicon.ico"
	rel="shortcut icon" type="image/x-icon">

<link href="./resources/img/tastebite-styles.css" rel="stylesheet"
...
<path
		...
		<div class="container">
			...
			<section class="tstbite-components my-4 my-md-5">
				<h5 class="py-3 mb-0">About</h5>
				<div class="about-detail">
					<hr class="my-0 my-md-4">
					<br>
					<h2>We’re a group of foodies who love cooking and the internet</h2>
					<br> <img src="./resources/img/menu150.jpg" class="w-100"
						alt="Menu"> <br> <br>
					<p>Food qualities braise chicken cuts bowl through slices
						butternut snack. Tender meat juicy dinners. One-pot low heat
						plenty of time adobo fat raw soften fruit. sweet renders bone-in
						marrow richness kitchen, fricassee basted pork shoulder. Delicious
						butternut squash hunk.</p>
					<br>
					<div class="row pt-md-5 mt-md-4">
						<div class="col-lg-6 order-2 order-md-0">
							<h2>Simple, Easy Recipes for all</h2>
							<p>Juicy meatballs brisket slammin' baked shoulder. Juicy
								smoker soy sauce burgers brisket. polenta mustard hunk greens.
								Wine technique snack skewers chuck excess. Oil heat slowly.
								slices natural delicious, set aside magic tbsp skillet, bay
								leaves brown centerpiece.</p>
						</div>
						<div class="col-lg-6">
							<img src="./resources/img/menu151.jpg" class="w-100 mb-3"
								alt="Menu">
						</div>
					</div>
					<br> <br>
				...
				<div class="mt-4 mt-md-5 pt-3 pt-md-4">
					<h2 class="pr-0 pr-lg-5">An incredible team of talented chefs
						and foodies</h2>
					<div class="row mt-5">
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team1.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
												<a href="about.html#0"><img
													src="./resources/img/behance.svg" alt="Behance"></a> <a
													href="about.html#0"><img
													src="./resources/img/dribbble.svg" alt="Dribbble"></a> <a
													href="about.html#0"><img
													src="./resources/img/twitter-fill.svg" alt="Twitter"></a>
											</div>
										</div>
									</div>
								</div>
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Ham
										Chuwon</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						</div>
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team2.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Izabella
										Tabakova</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team3.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Fatima
										Delgadillo</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team4.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Harrison
										Phillips</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team5.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Pablo
										Cambeiro</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team6.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Corabelle
										Durrad</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team7.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Nonkosi
										Joyi</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team8.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Wen
										Yahui</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team9.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Jurrien
										Oldhof</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team10.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Tallah
										Cotton</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team11.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Qin
										Shi</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
						...
						<div class="col-xl-2 col-md-3 col-6">
							<figure class="team-box text-center">
								<div class="team-circle">
									<img src="./resources/img/team12.png" class="rounded-circle"
										alt="Team">
									<div class="mate-info">
										<div class="havoc-table-container">
											<div class="havoc-align-container">
								...
								<figcaption class="mt-2 mt-md-3">
									<h6 class="font-weight-medium font-size-16 inter-font mb-0">Su
										Hua</h6>
									<small class="text-gray-300">Chef Extraordinaire</small>
								</figcaption>
							</figure>
			...
			<section class="tstbite-components my-1 my-md-5 py-1 py-md-5">
				<div class="row">
					<div class="col-md-6">
						<strong class="font-weight-semibold font-size-20 d-block mb-2">Operatring
							from NYC, Dubai and London</strong> <small class="text-dark-300">Gastronomy
							atmosphere set aside. Slice butternut cooking home. Delicious
							romantic undisturbed raw platter will meld. Thick Skewers skillet
							natural, smoker soy sauce wait roux. slices rosette bone-in
							simmer precision alongside baby leeks. Crafting renders aromatic
							enjoyment.</small> <br> <br>
						<hr>
						<br>
						<div class="d-flex align-items-center tstbite-svg">
...
<path
						...
						<ul>
							<li><a
								href="about.html#0">About
									us</a></li>
							<li><a
								href="about.html#0">Careers</a></li>
							<li><a
								href="about.html#0">Contact
									us</a></li>
							<li><a
								href="about.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="about.html#0">Terms</a></li>
							<li><a
								href="about.html#0">Conditions</a></li>
							<li><a
								href="about.html#0">Cookies</a></li>
							<li><a
								href="about.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="about.html#0">Facebook</a></li>
							<li><a
								href="about.html#0">Twitter</a></li>
							<li><a
								href="about.html#0">Instagram</a></li>
							<li><a
								href="about.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<path
	...
	<script src="./resources/js/swiper-bundle.min.js.다운로드"
		type="text/javascript"></script>
	<script src="./resources/js/masonry.min.js.다운로드" type="text/javascript"></script>
	<script src="./resources/js/tastebite-scripts.js.다운로드"
		type="text/javascript"></script>
	<script defer="" src="./resources/js/beacon.min.js.다운로드"
		data-cf-beacon="{&quot;rayId&quot;:&quot;6a50d6151bf82079&quot;,&quot;version&quot;:&quot;2021.10.0&quot;,&quot;r&quot;:1,&quot;token&quot;:&quot;9ae02b4a12234f118cf01e6f25c04e9d&quot;,&quot;si&quot;:100}"></script>
