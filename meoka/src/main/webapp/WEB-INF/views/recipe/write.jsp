			...
			<section class="tstbite-components my-4 my-md-5">
				<div class="d-sm-flex">
					...
					<div>
						...
						<h3><input type='text' class="py-2 py-md-3 mb-0" name="RECIPENAME" placeholder='제목'></h3> 
						</div>
					</div>
				</div>
				<div class="d-flex flex-wrap">
					<div class="my-2 mr-4">
						<!--<img src="../resources/img/avatar11.png"
							...
							<label>작성자</label> <input type="text" name="MEMBERID" /><br />
					</div>
					<div class="my-2 mr-4">
					...
					<div ><!-- class="row mt-0 mt-md-5" -->
						...
						<h6>요리정보</h6>
							<ul class="list-unstyled component-list tstbite-svg">
								<li><small>조리시간</small><span><input type="text" name="COOKINGTIME" /></span><br /></li>
								<li><small>수준</small>
									<span>
											<select name="RANKNO">
								...
								<li><small>양</small> <span><input type="text" name="PORTION" /><br />  </span></li>
							</ul>
						</div>
								</div>
...
<path
						...
						<ul>
							<li><a
								href="profile.html">About
									us</a></li>
							<li><a
								href="profile.html">Careers</a></li>
							<li><a
								href="profile.html">Contact
									us</a></li>
							<li><a
								href="profile.html">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="profile.html">Terms</a></li>
							<li><a
								href="profile.html">Conditions</a></li>
							<li><a
								href="profile.html">Cookies</a></li>
							<li><a
								href="profile.html">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="profile.html">Facebook</a></li>
							<li><a
								href="profile.html">Twitter</a></li>
							<li><a
								href="profile.html">Instagram</a></li>
							<li><a
								href="profile.html">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
	 ...
	 $(".uploadedList").on("click", "delbtn", function(event){
	   ...
	   $.ajax({
		   ...
		   success:function(result){
			   if(result == 'deleted'){
				   $($(that).parent().children("div[class='fileDrop']")).remove();
