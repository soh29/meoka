			...
			<section class="tstbite-components my-4 my-md-5">
				<div class="row align-items-center pt-0 pt-md-5">
					...
					<div class="col-lg-3 col-4 text-right">
						<a href="profile.html#0"
							class="btn btn-lg btn-primary px-4 px-md-5 text-uppercase">Save</a>
					</div>
				</div>
				<hr>
				<div
					class="d-flex flex-wrap pt-3 pt-md-5 pb-4 mb-2 align-items-center">
...
<path
														...
														transform="translate(3 2)" fill="#7f7f7f"></path>
</svg>
											</span>
										</div>
									</div>
...
<path
														...
														transform="translate(0.999 0.999)" fill="#7f7f7f"></path>
</svg>
											</span>
										</div>
									</div>
									...
									<div class="form-group custom-form-group">
										...
										<div class="form-control-box">
											<input type="text" class="form-control"
												value="suzan@gmail.com"> <span class="form-icon">
...
<path
							...
							<div class="mt-3 mt-md-5 pt-2 pt-md-4 pb-1">
								<h6
									class="f-size-20 inter-font font-weight-semibold mb-3 mb-md-5">Connected
									Accounts</h6>
								<div class="form-group custom-form-group">
									<div class="d-flex flex-wrap">
										...
										<span class="ml-auto mt-2"><a
											href="profile.html#0">Disconnect</a></span>
									</div>
							...
							<div class="mt-3 mt-md-5">
								<h6
									class="f-size-20 inter-font font-weight-semibold mb-2 mb-md-4 pb-2">Newsletter</h6>
							...
							<div
								...
								<a href="profile.html#0">
									<svg data-name="feather-icon/log-out"
										xmlns="http://www.w3.org/2000/svg" width="24" height="24"
										viewBox="0 0 24 24">
<rect data-name="Bounding Box" width="24" height="24"
											fill="rgba(255,255,255,0)"></rect>
...
<path
						...
						<ul>
							<li><a
								href="profile.html#0">About
									us</a></li>
							<li><a
								href="profile.html#0">Careers</a></li>
							<li><a
								href="profile.html#0">Contact
									us</a></li>
							<li><a
								href="profile.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="profile.html#0">Terms</a></li>
							<li><a
								href="profile.html#0">Conditions</a></li>
							<li><a
								href="profile.html#0">Cookies</a></li>
							<li><a
								href="profile.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="profile.html#0">Facebook</a></li>
							<li><a
								href="profile.html#0">Twitter</a></li>
							<li><a
								href="profile.html#0">Instagram</a></li>
							<li><a
								href="profile.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
