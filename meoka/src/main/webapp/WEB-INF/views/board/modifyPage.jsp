...
<form role="form" method="post">
	...
	제목<input name="title" type="text" value="${boardVO.title}"><br>
	작성자<input name="writer" type="text" value="${boardVO.writer}"><br>
	내용<textarea name="content">${boardVO.content}</textarea>
