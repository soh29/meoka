					...
					<div class="collapse navbar-collapse" id="menu-4">
						<ul class="navbar-nav m-auto pt-3 pt-lg-0">
							<li class="nav-item dropdown"><a class="nav-link"
								href="elements.html#" role="button" id="HomePage"
...
<path
							...
							<li class="nav-item dropdown"><a class="nav-link"
								href="elements.html#" role="button" id="RecipePage"
								data-toggle="dropdown" aria-haspopup="true"
...
<path
							...
							<li class="nav-item dropdown"><a class="nav-link"
								href="elements.html#" role="button" id="Pages"
								data-toggle="dropdown" aria-haspopup="true"
...
<path
	...
	<form role="form" method="get">
		...
		<select class="form-control border" style="height:50px; width:100px" name="searchOption">
			<option value="title"
		...
		<input name="keyword"  class="form-control border"  style="height:50px ;width:400px" placeholder="입력하세요" value="${map.keyword }">
		<button class="btn btn-primary"  type="submit">검색</button>
		<button class="btn btn-primary"  type="button" onclick="location.href='/board/register'">글
			작성</button>
		</div>
...
<path
						...
						<ul>
							<li><a href="elements.html#0">About us</a></li>
							<li><a href="elements.html#0">Careers</a></li>
							<li><a href="elements.html#0">Contact us</a></li>
							<li><a href="elements.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a href="elements.html#0">Terms</a></li>
							<li><a href="elements.html#0">Conditions</a></li>
							<li><a href="elements.html#0">Cookies</a></li>
							<li><a href="elements.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a href="elements.html#0">Facebook</a></li>
							<li><a href="elements.html#0">Twitter</a></li>
							<li><a href="elements.html#0">Instagram</a></li>
							<li><a href="elements.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="container">
				...
				<div class="row pb-4 pt-2 align-items-center">
					<div class="col-md-6 order-2 order-md-0">
						<p class="text-gray-300 small text-left mb-0">Â© 2020
							Tastebite - All rights reserved</p>
					</div>
					<div class="col-md-6">
						<div class="tstbite-social text-left text-md-right my-4 my-md-0">
							<a href="elements.html#0"> <svg
