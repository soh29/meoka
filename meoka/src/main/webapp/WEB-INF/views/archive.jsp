					...
					<div class="collapse navbar-collapse" id="menu-4">
						<ul class="navbar-nav m-auto pt-3 pt-lg-0">
							<li class="nav-item dropdown"><a class="nav-link"
								href="https://fabrx.co/preview/tastebite/archive.html#"
			...
			<section class="tstbite-components my-4 my-md-5 desserts-box">
				<div class="row align-items-end mb-0 mb-md-4 pt-0 pt-md-5">
					<div class="col-lg-9 col-md-8">
						<h5 class="py-3 mb-0">
							Desserts <sup>(98 Recipes)</sup>
						</h5>
						<p>One thing I learned living in the Canarsie section of
							Brooklyn, NY was how to cook a good Italian meal. Here is a
							recipe I created after having this dish in a restaurant. Enjoy!</p>
					</div>
					<div class="col-lg-3 col-md-4">
						<div class="sort-filter">
							<span>Sort by:</span> <select class="form-control">
								<option>Sort</option>
								<option>Sort</option>
							</select>
						</div>
					...
					<div class="col-lg-3 col-md-4 col-6">
						<figure class="my-3 my-md-4 tstbite-card">
							...
							<figcaption class="mt-2">
								<a href="https://fabrx.co/preview/tastebite/archive.html#0"
									class="text-black d-block mt-1 font-weight-semibold big">Decadent
									Raspberry and Cream Cake</a>
							</figcaption>
						</figure>
					</div>
					<div class="col-lg-3 col-md-4 col-6">
...
<path
						...
						<ul>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">About
									us</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Careers</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Contact
									us</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Terms</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Conditions</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Cookies</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Facebook</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Twitter</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Instagram</a></li>
							<li><a
								href="https://fabrx.co/preview/tastebite/archive.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
