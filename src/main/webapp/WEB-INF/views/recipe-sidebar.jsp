...
<!DOCTYPE html>
<!-- saved from url=(0054)recipe-sidebar.html -->
						...
						<div class="col-lg-8 col-md-7">
							<div class="border-md-right pr-0 pr-lg-5">
								<ul class="list-unstyled component-list tstbite-svg">
									<li><small>Prep Time</small> <span>15 min</span></li>
									<li><small>Prep Time</small> <span>15 min</span></li>
									...
									<li><a
										href="recipe-sidebar.html#0">
											<svg data-name="feather-icon/printer"
												...
												height="22.041" viewBox="0 0 20 22.041">
...
<path
									...
									<div class="checklist pb-2">
										...
										<div class="form-check form-check-rounded recipe-checkbox">
											<input type="checkbox" id="crackers" name="crackers"
												...
												class="form-check-label" for="crackers">400g graham
												crackers</label>
										</div>
										<div class="form-check form-check-rounded recipe-checkbox">
											<input type="checkbox" id="unsalted" name="unsalted"
												class="form-check-input"> <label
												class="form-check-label" for="unsalted">150g
												unsalted butters, melted</label>
										</div>
									</div>
									<div class="checklist pb-4">
										...
										<div class="form-check form-check-rounded recipe-checkbox">
											<input type="checkbox" id="marshmallows" name="marshmallows"
												class="form-check-input"> <label
												class="form-check-label" for="marshmallows">300g
												marshmallows</label>
										</div>
										<div class="form-check form-check-rounded recipe-checkbox">
											<input type="checkbox" id="melted" name="melted"
												class="form-check-input"> <label
												class="form-check-label" for="melted">175g unsalted
												butter, melted</label>
										</div>
										<div class="form-check form-check-rounded recipe-checkbox">
										...
										<div class="form-check form-check-rounded recipe-checkbox">
											<input type="checkbox" id="dropsblue" name="dropsblue"
												class="form-check-input"> <label
												class="form-check-label" for="dropsblue">3 drops
												blue food gel</label>
										</div>
									</div>
								</div>
								<div class="mt-3 mt-md-5">
									...
									<ul class="instruction-list list-unstyled">
										<li><span>1</span> To prepare crust add graham crackers
											to a food processor and process until you reach fine crumbs.
											Add melted butter and pulse 3-4 times to coat crumbs with
											butter.</li>
										<li><span>2</span> Pour mixture into a 20cm (8”) tart
											tin. Use the back of a spoon to firmly press the mixture out
											across the bottom and sides of the tart tin. Chill for 30
											min.</li>
										...
										<li><span>4</span> Next, add the gelatine and water to a
											...
											seconds.</li>
										<li><span>5</span> Add the cream cheese to the
											marshmallow mixture and use a hand mixer or stand mixer
											fitted with a paddle attachment to mix until smooth.</li>
										...
										<li><span>8</span> Pour half the purple cheesecake
											mixture into the chill tart crust. Add half the blue and then
											add the remaining purple and blue in the tart tin. Use a
											spoon to drizzle some pink cheesecake on top. Use a skewer or
											the end of a spoon to swirl the pink. Add some small dots of
											the plain cheesecake mixture to create stars and then
											sprinkle some more starts on top before chilling for 2 hours.
										</li>
						...
						<div class="col-lg-4 col-md-5">
							<div class="rounded-12 bg-lightest-gray p-4">
								...
								<ul class="Nutrition-list list-unstyled">
									...
									<li><span>Total Carbohydrate</span> <span>22.3 g</span></li>
							...
							<div class=" mt-4 mt-md-5 pt-3 pt-md-5">
								<h6>Fresh Recipes</h6>
								<figure
									class="mt-4 pb-2 row g-0 align-items-center tstbite-card">
									<div class="col-4">
										<a
											href="recipe-sidebar.html"
											class="tstbite-animation stretched-link rounded-4"> <img
											src="./resources/img/menu145.jpg" class="w-100"
											alt="Menu">
										</a>
									</div>
									<figcaption class="bg-white col-8">
										<div class="pl-3">
												...
												<div class="float-left">
													<div class="fabrx-ratings has-rating rating">
														<input type="radio" id="radio6" name="rate2" value="1"
															...
															type="radio" id="radio8" name="rate2" value="3">
														<label for="radio8" class="custom-starboxes"></label> <input
															type="radio" id="radio9" name="rate2" value="4">
														<label for="radio9" class="custom-starboxes"></label> <input
															type="radio" id="radio10" name="rate2" value="5">
											...
											<h6 class="inter-font f-size-20 mt-2 font-weight-semibold">
												<a
													href="recipe-sidebar.html"
													class="text-black">Spinach and Cheese Pasta</a>
											</h6>
										</div>
									</figcaption>
								</figure>
								<figure
									...
									<div class="col-4">
										<a
											href="recipe-sidebar.html"
											class="tstbite-animation stretched-link rounded-4"> <img
											src="./resources/img/menu146.jpg" class="w-100"
											alt="Menu">
										</a>
									</div>
									<figcaption class="bg-white col-8">
										<div class="pl-3">
												...
												<div class="float-left">
													<div class="fabrx-ratings has-rating rating">
														<input type="radio" id="radio11" name="rate3" value="1"
															...
															type="radio" id="radio13" name="rate3" value="3">
														<label for="radio13" class="custom-starboxes"></label> <input
															type="radio" id="radio14" name="rate3" value="4">
														<label for="radio14" class="custom-starboxes"></label> <input
															type="radio" id="radio15" name="rate3" value="5">
											...
											<h6 class="inter-font f-size-20 mt-2 font-weight-semibold">
												<a
													href="recipe-sidebar.html"
													class="text-black">Perfect Fancy Glazed Donuts</a>
											</h6>
										</div>
									</figcaption>
								</figure>
								<figure
									...
									<div class="col-4">
										<a
											href="recipe-sidebar.html"
											class="tstbite-animation stretched-link rounded-4"> <img
											src="./resources/img/menu147.jpg" class="w-100"
											alt="Menu">
										</a>
									</div>
									<figcaption class="bg-white col-8">
												...
												<div class="float-left">
													<div class="fabrx-ratings has-rating rating">
														<input type="radio" id="radio16" name="rate4" value="1"
															...
															type="radio" id="radio18" name="rate4" value="3">
														<label for="radio18" class="custom-starboxes"></label> <input
															type="radio" id="radio19" name="rate4" value="4">
														<label for="radio19" class="custom-starboxes"></label> <input
															type="radio" id="radio20" name="rate4" value="5">
								...
								<figure
									...
									<div class="col-4">
										<a
											href="recipe-sidebar.html"
											class="tstbite-animation stretched-link rounded-4"> <img
											src="./resources/img/menu148.jpg" class="w-100"
											alt="Menu">
										</a>
									</div>
									<figcaption class="bg-white col-8">
										<div class="pl-3">
											...
											<h6 class="inter-font f-size-20 mt-2 font-weight-semibold">
												<a
													href="recipe-sidebar.html"
													class="text-black">Caramel Strawberry Milkshake</a>
											</h6>
										</div>
									</figcaption>
								</figure>
								<figure
									...
									<div class="col-4">
										<a
											href="recipe-sidebar.html"
											class="tstbite-animation stretched-link rounded-4"> <img
											src="./resources/img/menu149.jpg" class="w-100"
											alt="Menu">
										</a>
									</div>
									<figcaption class="bg-white col-8">
										<div class="pl-3">
											...
											<h6 class="inter-font f-size-20 mt-2 font-weight-semibold">
												<a
													href="recipe-sidebar.html"
													class="text-black">Chocolate and Banana Jar Cake</a>
											</h6>
										</div>
									</figcaption>
								</figure>
							...
							<div
								class="tstbite-components recipe-component bg-primary-light mt-5 rounded-6 py-5 px-4">
								<div class="text-center py-3">
									<h5 class="mb-3">Deliciousness to your inbox</h5>
									<p class="f-size-24 font-weight-regular">Enjoy weekly hand
										picked recipes and recommendations</p>
									...
									<small class="d-block">By joining our newsletter you
										agree to our <a
										href="recipe-sidebar.html#0"
				...
				<div class="row pt-4 pb-0 pb-md-5">
					<div class="col-md-6">
						<div class="tastebite-footer-contnet pr-0 pr-lg-5 mr-0 mr-md-5">
							<a
								href="recipe-sidebar.html#0">
								<img src="./resources/img/brand4.svg" alt="Tastebite">
							</a>
...
<path
						...
						<ul>
							<li><a
								href="recipe-sidebar.html#0">About
									us</a></li>
							<li><a
								href="recipe-sidebar.html#0">Careers</a></li>
							<li><a
								href="recipe-sidebar.html#0">Contact
									us</a></li>
							<li><a
								href="recipe-sidebar.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="recipe-sidebar.html#0">Terms</a></li>
							<li><a
								href="recipe-sidebar.html#0">Conditions</a></li>
							<li><a
								href="recipe-sidebar.html#0">Cookies</a></li>
							<li><a
								href="recipe-sidebar.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="recipe-sidebar.html#0">Facebook</a></li>
							<li><a
								href="recipe-sidebar.html#0">Twitter</a></li>
							<li><a
								href="recipe-sidebar.html#0">Instagram</a></li>
							<li><a
								href="recipe-sidebar.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<path
	...
	<script src="./resources/js/html5.min.js.다운로드"
		type="text/javascript"></script>
	<script src="./resources/js/sticky.min.js.다운로드"
		type="text/javascript"></script>
	...
	<script defer="" src="./resources/js/beacon.min.js.다운로드"
		data-cf-beacon="{&quot;rayId&quot;:&quot;6a50caf0ad460af4&quot;,&quot;version&quot;:&quot;2021.10.0&quot;,&quot;r&quot;:1,&quot;token&quot;:&quot;9ae02b4a12234f118cf01e6f25c04e9d&quot;,&quot;si&quot;:100}"></script>
