...
<!DOCTYPE html>
<!-- saved from url=(0049)favorites.html -->
...
<path
							...
							<li class="nav-item dropdown"><a class="nav-link show"
								href="favorites.html#"
								role="button" id="Pages" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="true"> <span>Pages</span>
...
<path
								...
								<div class="dropdown-menu show" aria-labelledby="Pages">
									<a class="dropdown-item"
			...
			<section class="tstbite-components my-4 my-md-5 desserts-box">
				<div class="row align-items-center pt-0 pt-md-5">
					<div class="col-lg-9 col-8">
						<h5 class="py-3 mb-0">
							<img src="./resources/img/badge-heart.svg" alt="Icon"
								class="mr-2"> Favorites
						</h5>
					</div>
				...
				<hr>
				<div class="d-flex flex-wrap pt-3 pb-4 mb-2 tstbite-svg">
					<div class="mr-2 mr-md-3">
						<small class="font-size-16">(98 Recipes)</small>
					</div>
					<div class="mx-2 mx-md-3">
						<a href="favorites.html#0">
							<svg data-name="feather-icon/edit"
...
</svg> <small class="pl-1 font-size-16">Select</small>
						</a>
					</div>
					<div class="mx-2 mx-md-3">
						<div class="form-check sm form-check-rounded">
							<input type="checkbox" id="crackers" name="crackers"
								class="form-check-input"> <label
								class="form-check-label" for="crackers">All</label>
						</div>
					</div>
					<div class="mx-2 mx-md-3">
						<a href="favorites.html#0">
...
<path
									d="M3.333,14.666a2,2,0,0,1-2-1.882l0-.118V4H.667a.667.667,0,0,1,0-1.334H3.333V2A2,2,0,0,1,5.216,0l.118,0H8a2,2,0,0,1,2,1.882L10,2v.667h2.667a.667.667,0,0,1,0,1.334H12v8.666a2,2,0,0,1-1.883,2l-.118,0Zm-.667-2a.666.666,0,0,0,.589.662l.077,0H10a.666.666,0,0,0,.662-.589l0-.078V4h-8Zm6-10V2a.666.666,0,0,0-.589-.662L8,1.333H5.333a.667.667,0,0,0-.662.589l0,.077v.667Zm-1.333,8v-4a.667.667,0,0,1,1.333,0v4a.667.667,0,1,1-1.333,0Zm-2.666,0v-4A.667.667,0,1,1,6,6.667v4a.667.667,0,1,1-1.333,0Z"></path>
</svg> <small class="pl-1 font-size-16">Delete</small>
						</a>
					</div>
				</div>
				<div class="row">
...
<path
						...
						<ul>
							<li><a
								href="favorites.html#0">About
									us</a></li>
							<li><a
								href="favorites.html#0">Careers</a></li>
							<li><a
								href="favorites.html#0">Contact
									us</a></li>
							<li><a
								href="favorites.html#0">Feedback</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="favorites.html#0">Terms</a></li>
							<li><a
								href="favorites.html#0">Conditions</a></li>
							<li><a
								href="favorites.html#0">Cookies</a></li>
							<li><a
								href="favorites.html#0">Copyright</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<h6 class="caption font-weight-medium mb-2 inter-font">
...
<path
						...
						<ul>
							<li><a
								href="favorites.html#0">Facebook</a></li>
							<li><a
								href="favorites.html#0">Twitter</a></li>
							<li><a
								href="favorites.html#0">Instagram</a></li>
							<li><a
								href="favorites.html#0">Youtube</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<path
	...
	<script defer="" src="./resources/js/beacon.min.js
		data-cf-beacon="{&quot;rayId&quot;:&quot;6a50ceea6f3af8d7&quot;,&quot;version&quot;:&quot;2021.10.0&quot;,&quot;r&quot;:1,&quot;token&quot;:&quot;9ae02b4a12234f118cf01e6f25c04e9d&quot;,&quot;si&quot;:100}"></script>
