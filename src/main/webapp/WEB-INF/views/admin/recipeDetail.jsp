...
<div class="box box-primary">
    ...
    <input type="text" class="name_input"
           ...
           name="RECIPENO" value="${recipe.RECIPENO}"/>
    </div>
    ...
    <input type="text" class="name_input"
           style="margin-bottom: 10px; width: 325px" id="ingredientName"
           name="ingredientName" value="${RecipeDetailVO.RECIPEDETAILNO}. ${RecipeDetailVO.RECIPEDETAIL}"/>
    </div>
    </c:forEach>
    ...
    <div class="box-footer">						
		...
		<input type="submit" value="삭제" onclick='btn_click("userDelete");'>
	</div>
					
	<div class="container">
		<a href="/recipe/modify?RECIPENO=${recipe.RECIPENO}" class="btn btn-primary px-5">레시피 수정</a>
		<a href="/recipe/delete?RECIPENO=${recipe.RECIPENO}"class="btn btn-primary px-5">레시피 삭제</a>
	</div>
