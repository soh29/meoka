            ...
            <div class="box box-primary">
               ...
               <div class="warp" style="width: 700px; margin: auto">
                 ...
                 <div class="form-group has-feedback" style="padding-left:390px; text-align:left; margin:15px;">                  
                  <input class= "btn btn-primary" type="submit" value="수정" onclick='btn_click("userUpdate");'>
                  <input class= "btn btn-primary" type="submit" value="탈퇴" onclick='btn_click("userDelete");'>
               </div>
