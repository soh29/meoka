		...
		<div class="row pt-4 pb-0 pb-md-5">
			<div class="col-md-6">
				<div class="tastebite-footer-contnet pr-0 pr-lg-5 mr-0 mr-md-5">
					...
					<p class="mt-3 text-gray-300 pr-0 pr-lg-5 mr-0 mr-lg-4">On our
						recipe site, you will be able to find recipes more easily than
						anywhere else through ingredients. If you like to cook, please use
						this</p>
				</div>
			</div>
			<div class="col-md-2">
...
<script src="/resources/js/tastebite-scripts.js" type="text/javascript"></script>
