...
<path
				...
				<c:if test="${not empty login}">
                     ...
                     <c:if test="${login.memberId == 'meoka'}">
                     <a href="/admin/index" class="btn btn-sm btn-outline-dark ml-0 ml-md-4" style="width:125px; height:28px; padding:3px 20px 2px 20px;">관리자 모드</a>
                     </c:if>
                  </c:if>
						...
						<c:if test="${empty login}">
							<a href="javascript:void(0);" data-toggle="modal"
								...
								style="width: 90px; height: 28px; padding: 3px 20px 2px 20px;">LOGIN</a>
						</c:if>
						<!-- lab end -->
...
<path id="Shape"
									...
									<div class="modal-body">
										<h6 class="text-uppercase mb-4 pb-2"
											style="font-size: 23px; font-family: inter, sans-serif;">LOGIN</h6>
...
<path
							...
							<li class="nav-item dropdown"><a class="nav-link" href="#"
								...
								aria-haspopup="true" aria-expanded="false"> <span>FOODTYPE
								</span> <svg xmlns="http://www.w3.org/2000/svg" width="9.333"
										height="5.333" viewBox="0 0 9.333 5.333">
<path
											d="M1.138.2A.667.667,0,0,0,.2,1.138l4,4a.667.667,0,0,0,.943,0l4-4A.667.667,0,1,0,8.2.2L4.667,3.724Z"></path>
								...
								<div class="dropdown-menu" aria-labelledby="RecipePage">
									<a class="dropdown-item" href="/food/list">FOODTYPE LIST
									</a> <a class="dropdown-item" href="/food/write">FOODTYPE REGISTER</a>
								</div></li>
												<li class="nav-item dropdown"><a class="nav-link" href="#"
								role="button" id="RecipePage" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false"> <span>THEME
								</span> <svg xmlns="http://www.w3.org/2000/svg" width="9.333"
										height="5.333" viewBox="0 0 9.333 5.333">
<path
											d="M1.138.2A.667.667,0,0,0,.2,1.138l4,4a.667.667,0,0,0,.943,0l4-4A.667.667,0,1,0,8.2.2L4.667,3.724Z"></path>
								...
								<div class="dropdown-menu" aria-labelledby="RecipePage">
									<a class="dropdown-item" href="/theme/list">THEME LIST 
									</a> <a class="dropdown-item" href="/theme/write">THEME REGISTER </a>
								</div></li>


			<li class="nav-item dropdown"><a class="nav-link" href="#"
								role="button" id="RecipePage" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false"> <span>FOOD THEME
								</span> <svg xmlns="http://www.w3.org/2000/svg" width="9.333"
										height="5.333" viewBox="0 0 9.333 5.333">
<path
											d="M1.138.2A.667.667,0,0,0,.2,1.138l4,4a.667.667,0,0,0,.943,0l4-4A.667.667,0,1,0,8.2.2L4.667,3.724Z"></path>
								...
								<div class="dropdown-menu" aria-labelledby="RecipePage">
									 <a class="dropdown-item" href="/foodTheme/list">FOOD-THEME LIST</a>
									<a class="dropdown-item" href="/foodTheme/write">FOOD-THEME REGISTER</a>
								</div></li>
								
							<li class="nav-item"><a class="nav-link" href="/price">PRICE TREND</a></li>
