...
<body>
	...
	<h1
		style="font-size: 40px; font-weight: 600; margin-top: 5%; margin-bottom: 5%;">
		Q&A PAGE</h1>
	...
	<form role="form" method="get">
		...
		<div class="input-group custom-input-group pl-0 pl-lg-5"
			...
			<c:if test="${not empty login}">
				<button class="btn btn-primary" type="button"
					style="width: 90px; border-radius: 0;"
		...
		<div
			style="display: block; text-align: center; margin-top: 5%; margin-bottom: 3%;">
